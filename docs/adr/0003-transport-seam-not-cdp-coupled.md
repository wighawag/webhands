...
> Refined by [ADR-0004](0004-verb-surface-exposes-playwright-locator-semantics.md): "transport-neutral" is defined as Playwright-equivalent locator semantics (the no-CDP-leak rule below is unchanged).
