...
Adds a "Where hands change the game" subsection under the README scoreboard section, rewrites the Scope "hands" bullet around the ceiling+accelerator framing, and adds a matching note to `evals/SCOREBOARD.md`. Points at the incubating `review-crystallizes-session-into-hand` idea as the cheap hand-authoring path.
